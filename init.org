...
Assuming elpy dependencies are installed in ~/.emacs.d/emacs-env
...
Unfortunately, each virtualenv must have elpy's requirements
installed. This function installs these requirements from within
Emacs.
